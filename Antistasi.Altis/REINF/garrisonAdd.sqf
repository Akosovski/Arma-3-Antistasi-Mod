...
private _max = [_marcador] call A3A_fnc_garrisonSize;
if (_max <= count (garrison getVariable _marcador)) exitWith {hint format ["This garrison has no room for additional troops. Max troops is %1",_max]};
