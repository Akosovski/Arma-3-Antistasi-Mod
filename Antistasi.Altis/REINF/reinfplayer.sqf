...
private ["_chequeo","_hr","_tipounidad","_coste","_resourcesFIA","_unit","_pos"];
...
_pos = (position player) findEmptyPosition [2,50,_tipoUnidad];
if (_pos isEqualTo []) then {_pos = position player};
