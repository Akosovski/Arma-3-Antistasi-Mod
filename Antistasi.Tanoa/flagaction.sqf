...
switch _tipo do
	...
	case "evac": {_flag addAction ["<t>Evacuate squad</t> <img image='\a3\ui_f\data\IGUI\Cfg\holdactions\holdAction_thumbsup_ca.paa' size='1.6' shadow=2 />", "AI\EvacSquad.sqf",nil,6,true,true,"","(isPlayer _this) and (_this == _this getVariable ['owner',objNull]) and ([_target] call A3A_fnc_canFight)",4]};
